...
//DigiQR - Copyright (c) Matthew Cornelisse
function k(f,d){var b="Byte";f==f.replace(/[^0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ \$\%\*\+\-\.\/\:]/g,"")&&(b="Alphanumeric");var c=c||200;d=d||!1;var l=document.createElement("canvas");l.height=l.width=c;var a=l.getContext("2d"),g=qrcode(0,d?"H":"L");g.addData(f,b);g.make();var b=g.getModuleCount(),e=Math.floor(c/b),c=Math.floor((c-b*e)/2);a.save();a.translate(c,c);g.renderTo2dContext(a,e);var c=e*b/2,h=e,h=5>d?h*Math.min(Math.floor((Math.sqrt(.2*b*b)+1)/2)-.5,.5*(b-16)):.5*h*(b-1);a.save();a.transform(h,
0,0,h,c,c);a.save();1==d&&(a.beginPath(),a.fillStyle="#FFFFFF",a.rect(-1,-1,2,2),a.closePath(),a.fill());2==d&&(a.beginPath(),a.fillStyle="#FFFFFF",a.arc(0,0,1,0,2*Math.PI),a.closePath(),a.fill());0<d&&(a.beginPath(),a.fillStyle="#0066cc",a.arc(0,0,.891,0,2*Math.PI),a.closePath(),a.fill(),a.beginPath(),a.fillStyle="#002352",a.arc(0,0,.709,0,2*Math.PI),a.closePath(),a.fill(),a.fillStyle="#FFFFFF",a.beginPath(),a.moveTo(.245,-.361),a.lineTo(.27,-.428),a.bezierCurveTo(.273,-.435,.268,-.442,.261,-.442),
a.lineTo(.166,-.442),a.lineTo(.136,-.363),a.lineTo(.094,-.363),a.lineTo(.118,-.428),a.bezierCurveTo(.121,-.435,.116,-.442,.109,-.442),a.lineTo(.014,-.442),a.lineTo(-.016,-.363),a.lineTo(-.313,-.363),a.bezierCurveTo(-.327,-.363,-.339,-.356,-.346,-.344),a.lineTo(-.42,-.214),a.lineTo(-.317,-.214),a.lineTo(.134,-.214),a.bezierCurveTo(.152,-.214,.17,-.211,.187,-.204),a.bezierCurveTo(.221,-.19,.259,-.16,.249,-.091),a.bezierCurveTo(.233,.024,.116,.228,-.139,.231),a.lineTo(-.007,-.111),a.bezierCurveTo(-.002,
-.125,-.012,-.14,-.028,-.14),a.lineTo(-.204,-.14),a.lineTo(-.417,.383),a.bezierCurveTo(-.417,.383,-.374,.388,-.307,.388),a.lineTo(-.329,.443),a.lineTo(-.231,.443),a.bezierCurveTo(-.223,.443,-.216,.439,-.213,.431),a.lineTo(-.195,.384),a.bezierCurveTo(-.18,.383,-.166,.381,-.151,.379),a.lineTo(-.175,.443),a.lineTo(-.078,.443),a.bezierCurveTo(-.07,.443,-.063,.439,-.061,.431),a.lineTo(-.033,.359),a.bezierCurveTo(.127,.323,.298,.243,.4,.076),a.bezierCurveTo(.606,-.26,.392,-.346,.245,-.361),a.closePath(),
a.fill());a.restore();a.restore();a.save();a.transform(e,0,0,e,e/2,e/2);a.save();if(5<=d)for(a.fillStyle="rgba(255,255,255,0.5)",e=0;e<b;e++)for(c=0;c<b;c++)g.isDark(c,e)||(a.beginPath(),5==d&&a.arc(c,e,.5,0,2*Math.PI),6==d&&a.rect(c-.5,e-.5,1,1),a.closePath(),a.fill());a.restore();a.restore();a.restore();return l.toDataURL("image/jpg")}
$.DigiQR={request:function(f,d,b,c){return k("digibyte:"+f+"?amount="+d.toFixed(8),c)},address:function(f,d,b){return k(address,b)},explorer:function(f,d,b){return k("https://digiexplorer.info/address/"+f,b)},text:function(f,d,b){return k(f,b)}};
// **END**
})(window);