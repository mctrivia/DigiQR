...
(function() {(function(E,K){function F(){for(var a=E.getElementsByClassName("DigiQR"),b=0;b<a.length;b++){var c=a[b].getAttribute("uri");if(!c){c=a[b].getAttribute("address")||!1;if(!c)continue;var d=a[b].getAttribute("amount")||!1,c="digibyte:"+c;d&&(c+=0==d?0:"?amount="+parseFloat(d).toFixed(8))}var d=parseInt(a[b].getAttribute("size")||300),l=parseInt(a[b].getAttribute("logo")||6),m=parseFloat(a[b].getAttribute("r")||.5),p="digiid://"==c.toLowerCase().substr(0,9)?1:0;a[b].src=w(c,d,l,m,p);a[b].style.cursor=
